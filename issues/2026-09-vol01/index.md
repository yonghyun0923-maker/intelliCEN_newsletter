...
date: 2026-09-04
summary: 개발 플랫폼 "PMS Core" 오픈, WBS 개선 4건, 그리고 결함관리 이미지 주석 소식
links:
...
- **진척단계별 권한 설정**: 진척 단계(PM확인, 고객확인 등)에 따라 입력·수정 권한을 다르게 설정할 수 있습니다. 단계가 넘어간 항목은 함부로 고쳐지지 않도록 관리할 수 있습니다.
- **진척입력 이력관리**: 진척단계를 입력하거나 수정할 때마다 이력이 남습니다. 언제, 누가, 어떤 값으로 바꿨는지 나중에 다시 확인할 수 있습니다.
- **WBS 수정 승인 및 이력관리**: WBS 내용을 수정하면 담당자 승인을 거쳐야 반영됩니다. 승인 여부와 처리 이력도 함께 남아 나중에 확인할 수 있습니다.
