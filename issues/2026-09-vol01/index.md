...
- **진척단계별 권한 설정**: 진척 단계(계획·진행중·완료 등)에 따라 입력·수정 권한을 다르게 설정할 수 있습니다. 단계가 넘어간 항목은 함부로 고쳐지지 않도록 관리할 수 있습니다.
- **진척입력 이력관리**: 진척률을 입력하거나 수정할 때마다 이력이 남습니다. 언제, 누가, 어떤 값으로 바꿨는지 나중에 다시 확인할 수 있습니다.
